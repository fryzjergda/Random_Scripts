...
# stack \
/*  CG    GC    GU    UG    AU    UA    @  */ \
  -203  -271  -178   -85  -199  -178     0 \
  -271  -300  -193  -127  -189  -211     0 \
  -178  -193    30   -71   -88   -47     0 \
   -85  -127   -71   -70    -1     0     0 \
  -199  -189   -88    -1   -99   -69     0 \
  -178  -211   -47     0   -69   -91     0 \
     0     0     0     0     0     0     0 \
 \
# stack_enthalpies \
/*  CG    GC    GU    UG    AU    UA    @  */ \
...
/* UA.UU..UA */ \
 ...
 \
# hairpin \
   INF   INF   INF   475   532   524   499   503   485   540 \
   551   562   571   580   588   595   602   609   615   621 \
   626   631   636   641   646   650   654   659   662   666 \
   670 \
 \
# hairpin_enthalpies \
 ...
 \
# bulge \
   INF   311   203   266   354   327   340   357   371   384 \
   395   405   415   423   431   439   446   452   459   464 \
   470   475   480   485   490   494   498   502   506   510 \
   514 \
 \
# bulge_enthalpies \
 ...
 \
# interior \
   INF   INF   INF   INF    70   119   100   117   131   144 \
   155   165   175   183   191   199   206   212   219   224 \
   230   235   240   245   250   254   258   262   266   270 \
   274 \
 \
# interior_enthalpies \
...
/*    DuplexInit     TerminalAU   LXC  */ \
      410      0     11      0   107.856000      0 \
 \
# Triloops \
 \
# Tetraloops \
...
def get_andronescu(text):

    param_file = open("Rfold.param","w")    
